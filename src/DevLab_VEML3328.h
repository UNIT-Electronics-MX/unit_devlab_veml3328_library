#ifndef DEVLAB_VEML3328_H
#define DEVLAB_VEML3328_H
...
class DevLab_VEML3328Class {

  public:
    /* Singleton instance */
    static DevLab_VEML3328Class &instance() {
        static DevLab_VEML3328Class instance;
        return instance;
    }

    /**
     * @brief Initialize DevLab_VEML3328 library with defined address and
     * optional wire instance and pin swap.
     *
...
typedef DevLab_VEML3328Class VEMLClass;

extern DevLab_VEML3328Class &DevLab_VEML3328;
extern DevLab_VEML3328Class &Veml3328;
